...
%\usepackage[automake]{glossaries}
	...
	\newglossarystyle{tab_style}{
		...
		\renewcommand*{\glossentry}[2]{\glsentryitem{##1}\glstarget{##1}{\textbf{\glossentryname{##1}}} & \glossentrydesc{##1} & ##2 \tabularnewline[2px]} %3
...
\thesistitle{Untersuchung von Verfahren \\ zur Ausschnittsdetektion \\ für die Screen-Camera \\ Visible Light Communication} % Titel der Abschlussarbeit % no more than 4 lines here
\documentnumber{M\ 06-2017}%	MXX-20XX
\documenttype{Masterarbeit}%	Masterarbeit
\authorfirstname{Xiaoyu}%	Name des Autors
\authorsurname{Chen}%		Nachname des Autors
\matrikelnumber{181225}%		Matrikelnummer des Autors
\date{10. September 2018}%			Abgabedatum
...
\include{mainmatter/ErsteMethode}
\include{mainmatter/ZweiteMethode}
\include{mainmatter/Implementierung}
\include{mainmatter/Evaluierung}
