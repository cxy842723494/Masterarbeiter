...
\subsection{RANSAC}
Durch SURF Detektion findet es immer einige offensichtliche Mismatch-Punkte. Zur Lösung des Problems ist es immer erforderlich mit \gls{ransac}.
...
\begin{itemize}
	\item Die inlinere Daten können durch die Parameter mehrerer Gruppen von Modellen beschrieben werden, dagegen sind Ausreißer nicht zum Modellieren von Daten geeignet.
